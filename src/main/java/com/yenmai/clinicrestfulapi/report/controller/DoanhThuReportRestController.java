...
import com.yenmai.clinicrestfulapi.report.service.DoanhThuReportService;
...
@RestController
@RequestMapping("/baocao/doanhthu")
public class DoanhThuReportRestController {
    ...
    public void export(ModelAndView model, HttpServletResponse response,
        ...
        response.setHeader("Content-Disposition", String.format("attachment; filename=\"baocaodoanhthu.pdf\""));

        OutputStream out = response.getOutputStream();
        jasperPrint = doanhThuReportService.exportPdfFile(thangBaoCao, namBaoCao);
